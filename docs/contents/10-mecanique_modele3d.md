...
- Assemblage des 3 éléments de base en un seul fichier, allègement (retrait de matière), simplification du maillage (MeshLab / Meshmixer).
...
Imprimé en TPU pour stabiliser la tête, absorber son poids et protéger la base quand l'alimentation est coupée (option flex hose envisagée).
